...
For further information about how to use the wrapper please visit our [Documentation](https://github.com/emartech/react-native-emarsys-sdk/wiki/New-Architecture-and-Expo-framework "Wiki").
...
Please follow our [Expo Documentation](https://github.com/emartech/react-native-emarsys-sdk/wiki/New-Architecture-and-Expo-framework#expo) to set up SAP Emarsys SDK into your Expo app.

### Without Expo (Bare React Native)

Please follow our [Bare React Native Documentation](https://github.com/emartech/react-native-emarsys-sdk/wiki/New-Architecture-and-Expo-framework#bare-react-native) to set up SAP Emarsys SDK natively into your app’s native modules.
